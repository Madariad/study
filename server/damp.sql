...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Июн 23 2023 г., 21:28
...
CREATE TABLE `courses` (
  ...
  `course_description` varchar(225) CHARACTER SET armscii8 COLLATE armscii8_general_ci NOT NULL,
...
CREATE TABLE `sublessons` (
  ...
  `sublesson_title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sublesson_content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(27, 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6Ik1hZGFyYTE5MjlAZ21haWwuY29tIiwiaWF0IjoxNjg3NTQwNjMxfQ.eZ5vXT9Hc8Sr19esclt7uvk37_8dMPIay799v7jmOOI'),
...
CREATE TABLE `users` (
  ...
  `avatar` varchar(255) CHARACTER SET armscii8 COLLATE armscii8_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `users` (`user_id`, `username`, `password`, `role_id`, `email`, `avatar`) VALUES
(1, 'user1', 'password123', 2, 'las@gamii.com', NULL),
(2, 'user1', 'password123', 2, 'jjj@gamil.com', NULL),
(18, 'sss', '$2b$10$y4laX0FOo52OU5cNh6TtrOIfoJkffIHyWHE.BSSZfCJ1Co.xLSjSW', 1, 'lll$gmail.com', NULL),
(19, 'sss', '$2b$10$/oCTwic5i02PWpqIwJSB7esjuKDR07Z7YTO1/gaiTZEqVGjhlnndW', 1, 'll$gmail.com', NULL),
(20, 'sss', '$2b$10$eSZZ9t.oNivHqJr1TrKT5.xg24EnX44bhfOW9wdLbXJeEQByscMWW', 1, 'lp[pl$gmail.com', NULL),
(21, 'sss', '$2b$10$fY4iofocYenkImWN0TyWEOOPUVrzBWGHQ3bf2zNgCwYCp3muPitfu', 1, 'lppl$gmail.com', NULL),
(22, 'sss', '$2b$10$R4A5Ssjttdhp7e7lCeEoX.eXGL54RPKaEu/CBuZucgDukQd12Syhm', 1, 'lpp$gmail.com', NULL),
(23, 'sss', '$2b$10$WKk3inkWiGEQipP6YYrmxeznxfpx6Opx7F9UfvGNuKeXtQdzI374C', 1, 'lp$gmail.com', NULL),
(24, 'sss', '$2b$10$rrZGuRq4Fejpiox/qyob2udu8y8VtBtGP4UtAvhaiDzP/fkMubuF.', 1, 'l$gmail.com', NULL),
(25, 'sss', '$2b$10$KOQMEY4E.Vy5/o79isMnz.w5hlUTKKjy9TavDLSsH.OEv.ASSHwTW', 2, 'lsd$gmail.com', NULL),
(27, 'Madara', '$2b$10$QNlkvIzYrck/vTEP6al0yumjUouCp7El.h4Dia5W1STFV82ermP9S', 2, 'Madara1929@gmail.com', 'storage/user/images/1687542197973-avatarjpg.jpg'),
(28, 'Madaraasasasa12121212212', '$2b$10$XzAi1bwLzq.HfILgaX1vSutaUHbaGEc8ucmGZyqOn7UFHpzu0xWfu', 3, 'M1929@gmail.com', NULL),
(29, 'Wam', '$2b$10$YylFXExgSJlY88TZxdTy/Ou3vN/li8eP465hRx41DlsW2JOpAdWWC', 1, 'wamen@gmail.com', 'storage/user/images/1687543141706-wamen.jpg');
